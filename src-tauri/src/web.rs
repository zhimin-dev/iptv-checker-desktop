...
pub async fn start_web(port: u16) {
    ...
    // Shutdown flag for scheduler thread
    ...
    // Schedule periodic tasks
    {
        ...
        sched.every(clokwerk::TimeUnits::hours(1)).run(move || {
        ...
        sched.every(clokwerk::TimeUnits::seconds(30)).run(move || {
            run_check_tasks_with_lock(&lock_clone2, || {
